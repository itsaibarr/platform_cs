...
export const modules: Module[] = [
  {
    ...
    lessons: [
      ...
      },
      {
        ...
        homework: `Перейти на сайт https://blockly.games/maze?lang=en и решить задачи с мазайкой (скинуть нужно скрины решений)`,
      },
      {
        id: 5,
      ...
      },
      {
        ...
        youtubeUrl: "https://www.youtube.com/embed/HGTJBPNC-Gw?si=K2fKgoglyBL9keK1",
        homework: "Поделиться о том кем бы вы хотели стать в будущем.",
      },
      {
        id: 8,
